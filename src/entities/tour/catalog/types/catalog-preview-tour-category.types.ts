export const ENUM_CATALOG_PREVIEW_TOUR_CATEGORY = {
...
export type ENUM_CATALOG_PREVIEW_TOUR_CATEGORY_TYPE =
	(typeof ENUM_CATALOG_PREVIEW_TOUR_CATEGORY)[keyof typeof ENUM_CATALOG_PREVIEW_TOUR_CATEGORY];
