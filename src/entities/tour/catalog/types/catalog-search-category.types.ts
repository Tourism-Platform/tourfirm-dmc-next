export const ENUM_CATALOG_SEARCH_CATEGORY = {
...
export type ENUM_CATALOG_SEARCH_CATEGORY_TYPE =
	(typeof ENUM_CATALOG_SEARCH_CATEGORY)[keyof typeof ENUM_CATALOG_SEARCH_CATEGORY];
