...
interface ICatalogTourAdditionalInfoProps {
	data?: ICatalogPreviewTourData;
}

const CatalogTourAdditionalInfoBase: FC<ICatalogTourAdditionalInfoProps> = ({
	data
}) => {
...
export const CatalogTourAdditionalInfo = withErrorBoundary(
	CatalogTourAdditionalInfoBase
);
