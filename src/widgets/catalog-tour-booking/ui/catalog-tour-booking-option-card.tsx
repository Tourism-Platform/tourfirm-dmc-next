...
interface ICatalogTourBookingOptionCardProps {
...
export const CatalogTourBookingOptionCardBase: FC<
	ICatalogTourBookingOptionCardProps
...
export const CatalogTourBookingOptionCard = withErrorBoundary(
	CatalogTourBookingOptionCardBase
);
