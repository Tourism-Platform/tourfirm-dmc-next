...
export interface Config {
  ...
  globalsSelect: {
    ...
    'trade-fairs-hub': TradeFairsHubSelect<false> | TradeFairsHubSelect<true>;
    ...
    'ui-preview-sheet': UiPreviewSheetSelect<false> | UiPreviewSheetSelect<true>;
    'ui-booking': UiBookingSelect<false> | UiBookingSelect<true>;
  };
  locale: 'en' | 'ru' | 'uz' | 'es' | 'de' | 'fr' | 'it' | 'pt' | 'nl' | 'pl' | 'tr' | 'ar' | 'zh' | 'ja' | 'ko' | 'hi';
  widgets: {
